...
const VerifiedClinic_getDetails = ({ service }) => {
        ...
        <CCard>
          <CCardHeader>
            <div className="d-flex justify-content-between align-items-center">
              <h4 className="mb-0">{service?.categoryName} Verified Clinics</h4>
            </div>
          </CCardHeader>
                        ...
                        <CTableRow key={clinic?.clinicId || index}>
                          ...
                          <CTableDataCell className="text-center">
                            <button
                              className="actionBtn"
                              title="View"
                              onClick={() => navigate(`/Appointments_Tabs/${clinic.clinicId}`, { state: clinic })}
                            >
                              View
                            </button>
                          </CTableDataCell>
...
export default  VerifiedClinic_getDetails
